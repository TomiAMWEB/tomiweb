...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <source src="/video%20inicio%20/Superestrella%20MultiCam%20p1.mp4" type="video/mp4" />
      </video>
      ...
      >
        <source src="/video%20inicio%20/Superestrella%20MultiCam%20p2.mp4" type="video/mp4" />
      </video>
      ...
      >
        <source src="/logo/TAM%20-%20VISUAL.mp4" type="video/mp4" />
      </video>
